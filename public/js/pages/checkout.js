...
$(function () {
    ...
    $('#checkout-center').on('show.bs.modal', function (e) {
        ...
        if (type === 'tip' || type === 'chat-tip') {
            ...
            let showFedaProvider = !app.FedaRecurringDisabled;
            ...
            checkout.togglePaymentProvider(showFedaProvider, '.fedapay-payment-method');
 ...
 */
var checkout = {
    allowedPaymentProcessors: ['stripe', 'fedapay', 'paypal', 'credit', 'coinbase', 'nowpayments', 'ccbill', 'paystack', 'oxxo', 'mercado'],
    paymentData: {},
    ...
    validateAllFields: function (callback) {
        ...
        $.ajax({
            type: 'POST',
            data: $('#fedapay-buyItem').serialize(),
    ...
    getSelectedPaymentMethod: function () {
        ...
        const fedapayProvider = $('.fedapay-payment-provider').hasClass('selected');
