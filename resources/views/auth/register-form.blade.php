<form method="POST" action="{{ route('register') }}" id="register-form">
    ...
    {{-- <div class="form-group">
        <label for="referral_code" class=" col-form-label ">{{ __('Code de parrainage (optionnel)') }}</label>
        <div class=""> --}}
    {{-- <input id="text" type="text" class="form-control @error('text') is-invalid @enderror" name="text"
                value="{{ old('text') }}" autocomplete="text"> --}}
    {{--  <input type="text" class="form-control@error('text') is-invalid @enderror" id="referral_code"
    ...
    <div class="form-group ">
        ...
        <div class="">
            <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" required
